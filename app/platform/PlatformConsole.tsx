...
type PlatformAccess = { authenticated: boolean; email: string | null; plan: "demo" | "trial" | "pro" | "enterprise"; status: string; trialEndsAt: string | null; canUsePaidFeatures: boolean; isLocalDevelopment: boolean; limits: { rowsPerRun: number; rowsPerMonth: number; uploadBytesPerMonth: number }; usage: { processedRows: number; uploadBytes: number; runCount: number } };
