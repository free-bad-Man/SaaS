...
export default function CustomerSecurity() {
  ...
  return <main className="client-auth-page security-page">
    <header className="client-auth-nav"><Link href="/"><VerdictMark /><b>Verdict</b></Link><div><i /> ACCOUNT SECURITY</div><button type="button" onClick={() => void signOut()}>Sign out</button></header>
